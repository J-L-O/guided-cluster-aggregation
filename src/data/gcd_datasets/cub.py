...
def get_cub_datasets(root, train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
                    split_train_val=False, seed=0):

    np.random.seed(seed)

    # Init entire training set
    whole_training_set = CustomCub2011(root=root, transform=train_transform, train=True)
    ...
    test_dataset = CustomCub2011(root=root, transform=test_transform, train=False)
