...
def get_herbarium_datasets(root, train_transform, test_transform, train_classes=range(500), prop_train_labels=0.8,
    ...
    train_dataset = HerbariumDataset19(transform=train_transform,
                                            root=os.path.join(root, 'small-train'))
    ...
    test_dataset = HerbariumDataset19(transform=test_transform,
                                            root=os.path.join(root, 'small-validation'))
