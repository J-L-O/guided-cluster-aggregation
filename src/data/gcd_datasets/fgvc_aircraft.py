...
def get_aircraft_datasets(root, train_transform, test_transform, train_classes=range(50), prop_train_labels=0.8,
                    split_train_val=False, seed=0):

    np.random.seed(seed)

    # Init entire training set
    whole_training_set = FGVCAircraft(root=root, transform=train_transform, split='trainval')
    ...
    test_dataset = FGVCAircraft(root=root, transform=test_transform, split='test')
