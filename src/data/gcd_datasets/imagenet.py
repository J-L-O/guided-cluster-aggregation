...
def get_imagenet_100_datasets(root, train_transform, test_transform, train_classes=range(80),
    ...
    imagenet_training_set = ImageNetBase(root=os.path.join(root, 'train'), transform=train_transform)
    ...
    test_dataset = ImageNetBase(root=os.path.join(root, 'val'), transform=test_transform)
